...
This website and all course content is stored as [a version-controlled repository](https://github.com/leeper/surveycourse) on [GitHub](https://github.com/).
...
[Creating an account on GitHub is easy.](https://help.github.com/articles/signing-up-for-a-new-github-account) And so is [forking this repository](https://help.github.com/articles/fork-a-repo) to develop it into your own course. You can also download all of the content in the repository as a .zip [in one click](https://github.com/leeper/surveycourse/archive/gh-pages.zip).
