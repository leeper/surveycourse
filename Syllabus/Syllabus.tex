...
\subsubsection*{In-Class Activities}
\begin{itemize*}
\item Design an simple experiment to compare alternative question wordings
...
\emph{Before we launch a survey on our full sample, how do we check to make sure that it ``works''? What techniques can we use to validate our questionnaire before putting in the field?}
\vspace{1em}
\subsubsection*{Assignment Due}
...
\emph{How do we convince designated respondents to participate in a survey? How do respond to refusals to participate? How should we monitor the progress of a survey in the field and address challenges faced in the process?}
...
\reading[Selections from]{Lohr2009} % weighting
\reading[]{} % weighting
...
% codebooks, privacy (anonymizing), cleaning/missingness
% imputation
